        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              helperText={!!error && error.code === 'auth/weak-password' ? 'Password should be at least 6 characters.' : ''}
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              required
              fullWidth
              error={!!error && error.code === 'auth/passwords-dont-match'}
              helperText={!!error && error.code === 'auth/passwords-dont-match' ? 'Passwords do not match.' : ''}
            />
          </Grid>
          <Grid item xs={12}>
            <Button
